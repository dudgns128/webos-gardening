...
printf '{\n "id": "%s",\n "version": "%s",\n "vendor": "%s",\n "type": "web",\n "main": "index.html",\n "title": "%s",\n "icon": "icon.png",\n "allowVideoCapture": true,\n "requiredPermissions": [ "time.query", "activity.operation", "com.team17.homegardening.service.group", "database.operation", "peripheralmanager.i2c.operation", "application.launcher"]\n}' "com.team17.homegardening" "1.0.0" "my team" "new app" > appinfo.json
